...
namespace Disassembler.Decompiler
{
	public class CDecompiler
	{
		...
		{
			uint uiKernel = GetModuleSegment("KERNEL");
			
			this.oGlobalNamespace.APIFunctions.Add("GlobalAlloc", new CFunction(this, CallTypeEnum.Pascal, "GlobalAlloc", new List<CParameter>(new CParameter[] { new CParameter(CType.UInt, "fuAlloc"), new CParameter(CType.DWord, "cbAlloc") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HGLOBAL"), uiKernel, 15));
			this.oGlobalNamespace.APIFunctions.Add("GlobalReAlloc", new CFunction(this, CallTypeEnum.Pascal, "GlobalReAlloc", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HGLOBAL"), "hglb"), new CParameter(CType.DWord, "cbNewSize"), new CParameter(CType.UInt, "fuAlloc") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HGLOBAL"), uiKernel, 16));
			this.oGlobalNamespace.APIFunctions.Add("GlobalFree", new CFunction(this, CallTypeEnum.Pascal, "GlobalFree", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HGLOBAL"), "hglb") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HGLOBAL"), uiKernel, 17));
			this.oGlobalNamespace.APIFunctions.Add("GlobalLock", new CFunction(this, CallTypeEnum.Pascal, "GlobalLock", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HGLOBAL"), "hglb") }), CType.ObjectFarPtr, uiKernel, 18));
			this.oGlobalNamespace.APIFunctions.Add("GlobalUnlock", new CFunction(this, CallTypeEnum.Pascal, "GlobalUnlock", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HGLOBAL"), "hglb") }), CType.Bool, uiKernel, 19));
			this.oGlobalNamespace.APIFunctions.Add("GlobalSize", new CFunction(this, CallTypeEnum.Pascal, "GlobalSize", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HGLOBAL"), "hglb") }), CType.DWord, uiKernel, 20));
			this.oGlobalNamespace.APIFunctions.Add("GlobalHandle", new CFunction(this, CallTypeEnum.Pascal, "GlobalHandle", new List<CParameter>(new CParameter[] { new CParameter(CType.UInt, "uGlobalSel") }), CType.DWord, uiKernel, 21));
			this.oGlobalNamespace.APIFunctions.Add("GlobalCompact", new CFunction(this, CallTypeEnum.Pascal, "GlobalCompact", new List<CParameter>(new CParameter[] { new CParameter(CType.DWord, "dwMinFree") }), CType.DWord, uiKernel, 25));
			this.oGlobalNamespace.APIFunctions.Add("GetModuleFileName", new CFunction(this, CallTypeEnum.Pascal, "GetModuleFileName", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HINSTANCE"), "hinst"), new CParameter(CType.LPSTR, "lpszFilename"), new CParameter(CType.Int, "cbFileName") }), CType.Int, uiKernel, 49));
			this.oGlobalNamespace.APIFunctions.Add("MakeProcInstance", new CFunction(this, CallTypeEnum.Pascal, "MakeProcInstance", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("FARPROC"), "lpProc"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HINSTANCE"), "hinst") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("FARPROC"), uiKernel, 51));
			this.oGlobalNamespace.APIFunctions.Add("FreeProcInstance", new CFunction(this, CallTypeEnum.Pascal, "FreeProcInstance", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("FARPROC"), "lpProc") }), CType.Void, uiKernel, 52));
			this.oGlobalNamespace.APIFunctions.Add("FindResource", new CFunction(this, CallTypeEnum.Pascal, "FindResource", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HINSTANCE"), "hinst"), new CParameter(CType.LPCSTR, "lpszName"), new CParameter(CType.LPCSTR, "lpszType") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HRSRC"), uiKernel, 60));
			this.oGlobalNamespace.APIFunctions.Add("LoadResource", new CFunction(this, CallTypeEnum.Pascal, "LoadResource", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HINSTANCE"), "hinst"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HRSRC"), "hrsrc") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HGLOBAL"), uiKernel, 61));
			this.oGlobalNamespace.APIFunctions.Add("FreeResource", new CFunction(this, CallTypeEnum.Pascal, "FreeResource", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HGLOBAL"), "hglbResource") }), CType.Bool, uiKernel, 63));
			this.oGlobalNamespace.APIFunctions.Add("_lclose", new CFunction(this, CallTypeEnum.Pascal, "_lclose", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HFILE"), "hf") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HFILE"), uiKernel, 81));
			this.oGlobalNamespace.APIFunctions.Add("_lread", new CFunction(this, CallTypeEnum.Pascal, "_lread", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HFILE"), "hf"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("VoidHugePtr"), "hpvBuffer"), new CParameter(CType.UInt, "cbBuffer") }), CType.UInt, uiKernel, 82));
			this.oGlobalNamespace.APIFunctions.Add("_lcreat", new CFunction(this, CallTypeEnum.Pascal, "_lcreat", new List<CParameter>(new CParameter[] { new CParameter(CType.LPCSTR, "lpszFilename"), new CParameter(CType.Int, "fnAttribute") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HFILE"), uiKernel, 83));
			this.oGlobalNamespace.APIFunctions.Add("_llseek", new CFunction(this, CallTypeEnum.Pascal, "_llseek", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HFILE"), "hf"), new CParameter(CType.Long, "lOffset"), new CParameter(CType.Int, "nOrigin") }), CType.Long, uiKernel, 84));
			this.oGlobalNamespace.APIFunctions.Add("_lopen", new CFunction(this, CallTypeEnum.Pascal, "_lopen", new List<CParameter>(new CParameter[] { new CParameter(CType.LPCSTR, "lpszFilename"), new CParameter(CType.Int, "fnOpenMode") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HFILE"), uiKernel, 85));
			this.oGlobalNamespace.APIFunctions.Add("_lwrite", new CFunction(this, CallTypeEnum.Pascal, "_lwrite", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HFILE"), "hf"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("VoidHugePtr"), "hpvBuffer"), new CParameter(CType.UInt, "cbBuffer") }), CType.UInt, uiKernel, 86));
			this.oGlobalNamespace.APIFunctions.Add("lstrcpy", new CFunction(this, CallTypeEnum.Pascal, "lstrcpy", new List<CParameter>(new CParameter[] { new CParameter(CType.LPSTR, "lpszString1"), new CParameter(CType.LPCSTR, "lpszString2") }), CType.LPSTR, uiKernel, 88));
			this.oGlobalNamespace.APIFunctions.Add("lstrlen", new CFunction(this, CallTypeEnum.Pascal, "lstrlen", new List<CParameter>(new CParameter[] { new CParameter(CType.LPCSTR, "lpszString") }), CType.Int, uiKernel, 90));
			this.oGlobalNamespace.APIFunctions.Add("LoadLibrary", new CFunction(this, CallTypeEnum.Pascal, "LoadLibrary", new List<CParameter>(new CParameter[] { new CParameter(CType.LPCSTR, "lpszLibFileName") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HINSTANCE"), uiKernel, 95));
			this.oGlobalNamespace.APIFunctions.Add("GetDOSEnvironment", new CFunction(this, CallTypeEnum.Pascal, "GetDOSEnvironment", new List<CParameter>(new CParameter[] { }), CType.LPSTR, uiKernel, 131));
			this.oGlobalNamespace.APIFunctions.Add("GetWinFlags", new CFunction(this, CallTypeEnum.Pascal, "GetWinFlags", new List<CParameter>(new CParameter[] { }), CType.DWord, uiKernel, 132));
			this.oGlobalNamespace.APIFunctions.Add("GetFreeSpace", new CFunction(this, CallTypeEnum.Pascal, "GetFreeSpace", new List<CParameter>(new CParameter[] { new CParameter(CType.UInt, "fuFlags") }), CType.DWord, uiKernel, 169));
			this.oGlobalNamespace.APIFunctions.Add("hmemcpy", new CFunction(this, CallTypeEnum.Pascal, "hmemcpy", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("VoidHugePtr"), "hpvDest"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("VoidHugePtr"), "hpvSource"), new CParameter(CType.Long, "cbCopy") }), CType.Void, uiKernel, 348));
			this.oGlobalNamespace.APIFunctions.Add("_hread", new CFunction(this, CallTypeEnum.Pascal, "_hread", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HFILE"), "hf"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("VoidHugePtr"), "hpvBuffer"), new CParameter(CType.Long, "cbBuffer") }), CType.Long, uiKernel, 349));
			this.oGlobalNamespace.APIFunctions.Add("_hwrite", new CFunction(this, CallTypeEnum.Pascal, "_hwrite", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HFILE"), "hf"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("VoidHugePtr"), "hpvBuffer"), new CParameter(CType.Long, "cbBuffer") }), CType.Long, uiKernel, 350));

			uint uiUser = GetModuleSegment("USER");

			this.oGlobalNamespace.APIFunctions.Add("MessageBox", new CFunction(this, CallTypeEnum.Pascal, "MessageBox", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwndParent"), new CParameter(CType.LPCSTR, "lpszText"), new CParameter(CType.LPCSTR, "lpszTitle"), new CParameter(CType.UInt, "fuStyle") }), CType.Int, uiUser, 1));
			this.oGlobalNamespace.APIFunctions.Add("PostQuitMessage", new CFunction(this, CallTypeEnum.Pascal, "PostQuitMessage", new List<CParameter>(new CParameter[] { new CParameter(CType.Int, "nExitCode") }), CType.Void, uiUser, 6));
			this.oGlobalNamespace.APIFunctions.Add("SetTimer", new CFunction(this, CallTypeEnum.Pascal, "SetTimer", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(CType.UInt, "idTimer"), new CParameter(CType.UInt, "uTimeout"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("TIMERPROC"), "tmprc") }), CType.UInt, uiUser, 10));
			this.oGlobalNamespace.APIFunctions.Add("KillTimer", new CFunction(this, CallTypeEnum.Pascal, "KillTimer", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(CType.UInt, "idTimer") }), CType.Bool, uiUser, 12));
			this.oGlobalNamespace.APIFunctions.Add("GetTickCount", new CFunction(this, CallTypeEnum.Pascal, "GetTickCount", new List<CParameter>(new CParameter[] { }), CType.DWord, uiUser, 13));
			this.oGlobalNamespace.APIFunctions.Add("GetCursorPos", new CFunction(this, CallTypeEnum.Pascal, "GetCursorPos", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("PointFarPtr"), "lppt") }), CType.Void, uiUser, 17));
			this.oGlobalNamespace.APIFunctions.Add("SetCapture", new CFunction(this, CallTypeEnum.Pascal, "SetCapture", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), uiUser, 18));
			this.oGlobalNamespace.APIFunctions.Add("ReleaseCapture", new CFunction(this, CallTypeEnum.Pascal, "ReleaseCapture", new List<CParameter>(new CParameter[] { }), CType.Void, uiUser, 19));
			this.oGlobalNamespace.APIFunctions.Add("SetFocus", new CFunction(this, CallTypeEnum.Pascal, "SetFocus", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), uiUser, 22));
			this.oGlobalNamespace.APIFunctions.Add("ScreenToClient", new CFunction(this, CallTypeEnum.Pascal, "ScreenToClient", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("PointFarPtr"), "lppt") }), CType.Void, uiUser, 29));
			this.oGlobalNamespace.APIFunctions.Add("GetWindowRect", new CFunction(this, CallTypeEnum.Pascal, "GetWindowRect", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("RectFarPtr"), "lprc") }), CType.Void, uiUser, 32));
			this.oGlobalNamespace.APIFunctions.Add("GetClientRect", new CFunction(this, CallTypeEnum.Pascal, "GetClientRect", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("RectFarPtr"), "lprc") }), CType.Void, uiUser, 33));
			this.oGlobalNamespace.APIFunctions.Add("EnableWindow", new CFunction(this, CallTypeEnum.Pascal, "EnableWindow", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(CType.Bool, "fEnable") }), CType.Bool, uiUser, 34));
			this.oGlobalNamespace.APIFunctions.Add("IsWindowEnabled", new CFunction(this, CallTypeEnum.Pascal, "IsWindowEnabled", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd") }), CType.Bool, uiUser, 35));
			this.oGlobalNamespace.APIFunctions.Add("GetWindowText", new CFunction(this, CallTypeEnum.Pascal, "GetWindowText", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(CType.LPSTR, "lpsz"), new CParameter(CType.Int, "cbMax") }), CType.Int, uiUser, 36));
			this.oGlobalNamespace.APIFunctions.Add("SetWindowText", new CFunction(this, CallTypeEnum.Pascal, "SetWindowText", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(CType.LPCSTR, "lpsz") }), CType.Void, uiUser, 37));
			this.oGlobalNamespace.APIFunctions.Add("BeginPaint", new CFunction(this, CallTypeEnum.Pascal, "BeginPaint", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("PaintStructFarPtr"), "lpps") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), uiUser, 39));
			this.oGlobalNamespace.APIFunctions.Add("EndPaint", new CFunction(this, CallTypeEnum.Pascal, "EndPaint", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("PaintStructFarPtr"), "lpps") }), CType.Void, uiUser, 40));
			this.oGlobalNamespace.APIFunctions.Add("CreateWindow", new CFunction(this, CallTypeEnum.Pascal, "CreateWindow", new List<CParameter>(new CParameter[] { new CParameter(CType.LPCSTR, "lpszClassName"), new CParameter(CType.LPCSTR, "lpszWindowName"), new CParameter(CType.DWord, "dwStyle"), new CParameter(CType.Int, "x"), new CParameter(CType.Int, "y"), new CParameter(CType.Int, "nWidth"), new CParameter(CType.Int, "nHeight"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwndParent"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HMENU"), "hmenu"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HINSTANCE"), "hinst"), new CParameter(CType.ObjectFarPtr, "lpvParam") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), uiUser, 41));
			this.oGlobalNamespace.APIFunctions.Add("ShowWindow", new CFunction(this, CallTypeEnum.Pascal, "ShowWindow", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(CType.Int, "nCmdShow") }), CType.Bool, uiUser, 42));
			this.oGlobalNamespace.APIFunctions.Add("GetParent", new CFunction(this, CallTypeEnum.Pascal, "GetParent", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), uiUser, 46));
			...
			this.oGlobalNamespace.APIFunctions.Add("DestroyWindow", new CFunction(this, CallTypeEnum.Pascal, "DestroyWindow", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd") }), CType.Bool, uiUser, 53));
			this.oGlobalNamespace.APIFunctions.Add("MoveWindow", new CFunction(this, CallTypeEnum.Pascal, "MoveWindow", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(CType.Int, "nLeft"), new CParameter(CType.Int, "nTop"), new CParameter(CType.Int, "nWidth"), new CParameter(CType.Int, "nHeight"), new CParameter(CType.Bool, "fRepaint") }), CType.Bool, uiUser, 56));
			this.oGlobalNamespace.APIFunctions.Add("RegisterClass", new CFunction(this, CallTypeEnum.Pascal, "RegisterClass", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("WNDCLASS"), "lpwc") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("ATOM"), uiUser, 57));
			this.oGlobalNamespace.APIFunctions.Add("SetScrollPos", new CFunction(this, CallTypeEnum.Pascal, "SetScrollPos", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(CType.Int, "fnBar"), new CParameter(CType.Int, "nPos"), new CParameter(CType.Bool, "fRepaint") }), CType.Int, uiUser, 62));
			this.oGlobalNamespace.APIFunctions.Add("SetScrollRange", new CFunction(this, CallTypeEnum.Pascal, "SetScrollRange", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(CType.Int, "fnBar"), new CParameter(CType.Int, "nMin"), new CParameter(CType.Int, "nMax"), new CParameter(CType.Bool, "fRedraw") }), CType.Void, uiUser, 64));
			this.oGlobalNamespace.APIFunctions.Add("GetScrollRange", new CFunction(this, CallTypeEnum.Pascal, "GetScrollRange", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(CType.Int, "fnBar"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("IntFarPtr"), "lpnMinPos"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("IntFarPtr"), "lpnMaxPos") }), CType.Void, uiUser, 65));
			this.oGlobalNamespace.APIFunctions.Add("GetDC", new CFunction(this, CallTypeEnum.Pascal, "GetDC", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), uiUser, 66));
			this.oGlobalNamespace.APIFunctions.Add("ReleaseDC", new CFunction(this, CallTypeEnum.Pascal, "ReleaseDC", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc") }), CType.Int, uiUser, 68));
			this.oGlobalNamespace.APIFunctions.Add("SetCursor", new CFunction(this, CallTypeEnum.Pascal, "SetCursor", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HCURSOR"), "hcur") }), CType.Void, uiUser, 69));
			...
			this.oGlobalNamespace.APIFunctions.Add("PtInRect", new CFunction(this, CallTypeEnum.Pascal, "PtInRect", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("RectFarPtr"), "lprc"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("POINT"), "pt") }), CType.Bool, uiUser, 76));
			this.oGlobalNamespace.APIFunctions.Add("OffsetRect", new CFunction(this, CallTypeEnum.Pascal, "OffsetRect", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("RectFarPtr"), "lprc"), new CParameter(CType.Int, "x"), new CParameter(CType.Int, "y") }), CType.Void, uiUser, 77));
			this.oGlobalNamespace.APIFunctions.Add("InflateRect", new CFunction(this, CallTypeEnum.Pascal, "InflateRect", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("RectFarPtr"), "lprc"), new CParameter(CType.Int, "xAmt"), new CParameter(CType.Int, "yAmt") }), CType.Void, uiUser, 78));
			this.oGlobalNamespace.APIFunctions.Add("FillRect", new CFunction(this, CallTypeEnum.Pascal, "FillRect", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("RectFarPtr"), "lprc"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HBRUSH"), "hbr") }), CType.Int, uiUser, 81));
			this.oGlobalNamespace.APIFunctions.Add("FrameRect", new CFunction(this, CallTypeEnum.Pascal, "FrameRect", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("RectFarPtr"), "lprc"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HBRUSH"), "hbr") }), CType.Int, uiUser, 83));
			this.oGlobalNamespace.APIFunctions.Add("DrawText", new CFunction(this, CallTypeEnum.Pascal, "DrawText", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc"), new CParameter(CType.LPCSTR, "lpsz"), new CParameter(CType.Int, "cb"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("RectFarPtr"), "lprc"), new CParameter(CType.UInt, "fuFormat") }), CType.Int, uiUser, 85));
			this.oGlobalNamespace.APIFunctions.Add("CreateDialog", new CFunction(this, CallTypeEnum.Pascal, "CreateDialog", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HINSTANCE"), "hinst"), new CParameter(CType.LPCSTR, "lpszDlgTemp"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwndOwner"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("DLGPROC"), "dlgprc") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), uiUser, 89));
			this.oGlobalNamespace.APIFunctions.Add("IsDialogMessage", new CFunction(this, CallTypeEnum.Pascal, "IsDialogMessage", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwndDlg"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("MsgFarPtr"), "lpmsg") }), CType.Bool, uiUser, 90));
			this.oGlobalNamespace.APIFunctions.Add("GetDlgItem", new CFunction(this, CallTypeEnum.Pascal, "GetDlgItem", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwndDlg"), new CParameter(CType.Int, "idControl") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), uiUser, 91));
			this.oGlobalNamespace.APIFunctions.Add("SendDlgItemMessage", new CFunction(this, CallTypeEnum.Pascal, "SendDlgItemMessage", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwndDlg"), new CParameter(CType.Int, "idDlgItem"), new CParameter(CType.UInt, "uMsg"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("WPARAM"), "wParam"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("LPARAM"), "lParam") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("LRESULT"), uiUser, 101));
			this.oGlobalNamespace.APIFunctions.Add("MessageBeep", new CFunction(this, CallTypeEnum.Pascal, "MessageBeep", new List<CParameter>(new CParameter[] { new CParameter(CType.UInt, "uAlert") }), CType.Void, uiUser, 104));
			this.oGlobalNamespace.APIFunctions.Add("DefWindowProc", new CFunction(this, CallTypeEnum.Pascal, "DefWindowProc", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(CType.UInt, "uMsg"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("WPARAM"), "wParam"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("LPARAM"), "lParam") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("LRESULT"), uiUser, 107));
			this.oGlobalNamespace.APIFunctions.Add("PeekMessage", new CFunction(this, CallTypeEnum.Pascal, "PeekMessage", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("MsgFarPtr"), "lpmsg"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(CType.UInt, "uFilterFirst"), new CParameter(CType.UInt, "uFilterLast"), new CParameter(CType.UInt, "fuRemove") }), CType.Bool, uiUser, 109));
			this.oGlobalNamespace.APIFunctions.Add("SendMessage", new CFunction(this, CallTypeEnum.Pascal, "SendMessage", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(CType.UInt, "uMsg"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("WPARAM"), "wParam"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("LPARAM"), "lParam") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("LRESULT"), uiUser, 111));
			this.oGlobalNamespace.APIFunctions.Add("TranslateMessage", new CFunction(this, CallTypeEnum.Pascal, "TranslateMessage", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("MsgFarPtr"), "lpmsg") }), CType.Bool, uiUser, 113));
			this.oGlobalNamespace.APIFunctions.Add("DispatchMessage", new CFunction(this, CallTypeEnum.Pascal, "DispatchMessage", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("MsgFarPtr"), "lpmsg") }), CType.Long, uiUser, 114));
			this.oGlobalNamespace.APIFunctions.Add("UpdateWindow", new CFunction(this, CallTypeEnum.Pascal, "UpdateWindow", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd") }), CType.Void, uiUser, 124));
			this.oGlobalNamespace.APIFunctions.Add("InvalidateRect", new CFunction(this, CallTypeEnum.Pascal, "InvalidateRect", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("RectFarPtr"), "lprc"), new CParameter(CType.Bool, "fErase") }), CType.Void, uiUser, 125));
			this.oGlobalNamespace.APIFunctions.Add("ValidateRect", new CFunction(this, CallTypeEnum.Pascal, "ValidateRect", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("RectFarPtr"), "lprc") }), CType.Void, uiUser, 127));
			this.oGlobalNamespace.APIFunctions.Add("GetWindowWord", new CFunction(this, CallTypeEnum.Pascal, "GetWindowWord", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(CType.Int, "nOffset") }), CType.Word, uiUser, 133));
			this.oGlobalNamespace.APIFunctions.Add("SetWindowWord", new CFunction(this, CallTypeEnum.Pascal, "SetWindowWord", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(CType.Int, "nOffset"), new CParameter(CType.Word, "nVal") }), CType.Word, uiUser, 134));
			this.oGlobalNamespace.APIFunctions.Add("SetWindowLong", new CFunction(this, CallTypeEnum.Pascal, "SetWindowLong", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(CType.Int, "nOffset"), new CParameter(CType.Long, "nVal") }), CType.Long, uiUser, 136));
			this.oGlobalNamespace.APIFunctions.Add("CheckMenuItem", new CFunction(this, CallTypeEnum.Pascal, "CheckMenuItem", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HMENU"), "hmenu"), new CParameter(CType.UInt, "idCheckItem"), new CParameter(CType.UInt, "uCheck") }), CType.Bool, uiUser, 154));
			this.oGlobalNamespace.APIFunctions.Add("EnableMenuItem", new CFunction(this, CallTypeEnum.Pascal, "EnableMenuItem", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HMENU"), "hmenu"), new CParameter(CType.UInt, "idEnableItem"), new CParameter(CType.UInt, "uEnable") }), CType.Bool, uiUser, 155));
			this.oGlobalNamespace.APIFunctions.Add("GetMenu", new CFunction(this, CallTypeEnum.Pascal, "GetMenu", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HMENU"), uiUser, 157));
			this.oGlobalNamespace.APIFunctions.Add("DrawMenuBar", new CFunction(this, CallTypeEnum.Pascal, "DrawMenuBar", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd") }), CType.Void, uiUser, 160));
			this.oGlobalNamespace.APIFunctions.Add("WinHelp", new CFunction(this, CallTypeEnum.Pascal, "WinHelp", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(CType.LPCSTR, "lpszHelpFile"), new CParameter(CType.UInt, "fuCommand"), new CParameter(CType.DWord, "dwData") }), CType.Bool, uiUser, 171));
			this.oGlobalNamespace.APIFunctions.Add("LoadCursor", new CFunction(this, CallTypeEnum.Pascal, "LoadCursor", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HINSTANCE"), "hinst"), new CParameter(CType.LPCSTR, "pszCursor") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HCURSOR"), uiUser, 173));
			this.oGlobalNamespace.APIFunctions.Add("LoadIcon", new CFunction(this, CallTypeEnum.Pascal, "LoadIcon", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HINSTANCE"), "hinst"), new CParameter(CType.LPCSTR, "pszIcon") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HICON"), uiUser, 174));
			this.oGlobalNamespace.APIFunctions.Add("LoadAccelerators", new CFunction(this, CallTypeEnum.Pascal, "LoadAccelerators", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HINSTANCE"), "hinst"), new CParameter(CType.LPCSTR, "lpszTableName") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HACCEL"), uiUser, 177));
			this.oGlobalNamespace.APIFunctions.Add("TranslateAccelerator", new CFunction(this, CallTypeEnum.Pascal, "TranslateAccelerator", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HACCEL"), "haccl"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("MsgFarPtr"), "lpmsg") }), CType.Int, uiUser, 178));
			this.oGlobalNamespace.APIFunctions.Add("GetSystemMetrics", new CFunction(this, CallTypeEnum.Pascal, "GetSystemMetrics", new List<CParameter>(new CParameter[] { new CParameter(CType.Int, "nIndex") }), CType.Int, uiUser, 179));
			this.oGlobalNamespace.APIFunctions.Add("CreateDialogIndirect", new CFunction(this, CallTypeEnum.Pascal, "CreateDialogIndirect", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HINSTANCE"), "hinst"), new CParameter(CType.ObjectFarPtr, "lpvDlgTmp"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwndOwner"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("DLGPROC"), "dlgprc") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), uiUser, 219));
			this.oGlobalNamespace.APIFunctions.Add("GetKeyboardState", new CFunction(this, CallTypeEnum.Pascal, "GetKeyboardState", new List<CParameter>(new CParameter[] { new CParameter(new CType(CType.Byte, 256, "byte[]"), "lpbKeyState") }), CType.Void, uiUser, 222));
			this.oGlobalNamespace.APIFunctions.Add("SetKeyboardState", new CFunction(this, CallTypeEnum.Pascal, "SetKeyboardState", new List<CParameter>(new CParameter[] { new CParameter(new CType(CType.Byte, 256, "byte[]"), "lpbKeyState") }), CType.Void, uiUser, 223));
			this.oGlobalNamespace.APIFunctions.Add("GetDialogBaseUnits", new CFunction(this, CallTypeEnum.Pascal, "GetDialogBaseUnits", new List<CParameter>(new CParameter[] { new CParameter(CType.Void) }), CType.DWord, uiUser, 243));
			this.oGlobalNamespace.APIFunctions.Add("GetDlgCtrlID", new CFunction(this, CallTypeEnum.Pascal, "GetDlgCtrlID", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwnd") }), CType.Int, uiUser, 277));
			this.oGlobalNamespace.APIFunctions.Add("SelectPalette", new CFunction(this, CallTypeEnum.Pascal, "SelectPalette", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HPALETTE"), "hpal"), new CParameter(CType.Bool, "fPalBack") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HPALETTE"), uiUser, 282));
			this.oGlobalNamespace.APIFunctions.Add("RealizePalette", new CFunction(this, CallTypeEnum.Pascal, "RealizePalette", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc") }), CType.UInt, uiUser, 283));
			this.oGlobalNamespace.APIFunctions.Add("GetFreeSystemResources", new CFunction(this, CallTypeEnum.Pascal, "GetFreeSystemResources", new List<CParameter>(new CParameter[] { new CParameter(CType.UInt, "fuSysResource") }), CType.UInt, uiUser, 284));
			this.oGlobalNamespace.APIFunctions.Add("GetDesktopWindow", new CFunction(this, CallTypeEnum.Pascal, "GetDesktopWindow", new List<CParameter>(new CParameter[] { new CParameter(CType.Void) }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), uiUser, 286));
			this.oGlobalNamespace.APIFunctions.Add("DefDlgProc", new CFunction(this, CallTypeEnum.Pascal, "DefDlgProc", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HWND"), "hwndDlg"), new CParameter(CType.UInt, "uMsg"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("WPARAM"), "wParam"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("LPARAM"), "lParam") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("LRESULT"), uiUser, 308));
			this.oGlobalNamespace.APIFunctions.Add("ModifyMenu", new CFunction(this, CallTypeEnum.Pascal, "ModifyMenu", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HMENU"), "hmenu"), new CParameter(CType.UInt, "idItem"), new CParameter(CType.UInt, "fuFlags"), new CParameter(CType.UInt, "idNewItem"), new CParameter(CType.LPCSTR, "lpNewItem") }), CType.Bool, uiUser, 414));

			uint uiGdi = GetModuleSegment("GDI");

			this.oGlobalNamespace.APIFunctions.Add("SetBkColor", new CFunction(this, CallTypeEnum.Pascal, "SetBkColor", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("COLORREF"), "clrref") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("COLORREF"), uiGdi, 1));
			this.oGlobalNamespace.APIFunctions.Add("SetBkMode", new CFunction(this, CallTypeEnum.Pascal, "SetBkMode", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc"), new CParameter(CType.Int, "fnBkMode") }), CType.Int, uiGdi, 2));
			this.oGlobalNamespace.APIFunctions.Add("SetPolyFillMode", new CFunction(this, CallTypeEnum.Pascal, "SetPolyFillMode", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc"), new CParameter(CType.Int, "fnMode") }), CType.Int, uiGdi, 6));
			this.oGlobalNamespace.APIFunctions.Add("SetTextColor", new CFunction(this, CallTypeEnum.Pascal, "SetTextColor", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("COLORREF"), "clrref") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("COLORREF"), uiGdi, 9));
			this.oGlobalNamespace.APIFunctions.Add("LineTo", new CFunction(this, CallTypeEnum.Pascal, "LineTo", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc"), new CParameter(CType.Int, "nXEnd"), new CParameter(CType.Int, "nYEnd") }), CType.Bool, uiGdi, 19));
			this.oGlobalNamespace.APIFunctions.Add("MoveTo", new CFunction(this, CallTypeEnum.Pascal, "MoveTo", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc"), new CParameter(CType.Int, "nXPos"), new CParameter(CType.Int, "nYPos") }), CType.DWord, uiGdi, 20));
			this.oGlobalNamespace.APIFunctions.Add("SetPixel", new CFunction(this, CallTypeEnum.Pascal, "SetPixel", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc"), new CParameter(CType.Int, "nXPos"), new CParameter(CType.Int, "nYPos"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("COLORREF"), "clrref") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("COLORREF"), uiGdi, 31));
			this.oGlobalNamespace.APIFunctions.Add("TextOut", new CFunction(this, CallTypeEnum.Pascal, "TextOut", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc"), new CParameter(CType.Int, "nXStart"), new CParameter(CType.Int, "nYStart"), new CParameter(CType.LPCSTR, "lpszString"), new CParameter(CType.Int, "cbString") }), CType.Bool, uiGdi, 33));
			...
			this.oGlobalNamespace.APIFunctions.Add("CreateCompatibleDC", new CFunction(this, CallTypeEnum.Pascal, "CreateCompatibleDC", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), uiGdi, 52));
			...
			this.oGlobalNamespace.APIFunctions.Add("CreateFontIndirect", new CFunction(this, CallTypeEnum.Pascal, "CreateFontIndirect", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("LogFontFarPtr"), "lplf") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HFONT"), uiGdi, 57));
			this.oGlobalNamespace.APIFunctions.Add("CreatePatternBrush", new CFunction(this, CallTypeEnum.Pascal, "CreatePatternBrush", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HBITMAP"), "hbmp") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HBRUSH"), uiGdi, 60));
			this.oGlobalNamespace.APIFunctions.Add("CreatePen", new CFunction(this, CallTypeEnum.Pascal, "CreatePen", new List<CParameter>(new CParameter[] { new CParameter(CType.Int, "fnPenStyle"), new CParameter(CType.Int, "nWidth"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("COLORREF"), "clrref") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HPEN"), uiGdi, 61));
			this.oGlobalNamespace.APIFunctions.Add("CreateSolidBrush", new CFunction(this, CallTypeEnum.Pascal, "CreateSolidBrush", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("COLORREF"), "clrref") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HBRUSH"), uiGdi, 66));
			this.oGlobalNamespace.APIFunctions.Add("DeleteDC", new CFunction(this, CallTypeEnum.Pascal, "DeleteDC", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc") }), CType.Bool, uiGdi, 68));
			this.oGlobalNamespace.APIFunctions.Add("DeleteObject", new CFunction(this, CallTypeEnum.Pascal, "DeleteObject", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HGDIOBJ"), "hgdiobj") }), CType.Bool, uiGdi, 69));
			this.oGlobalNamespace.APIFunctions.Add("GetBitmapBits", new CFunction(this, CallTypeEnum.Pascal, "GetBitmapBits", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HBITMAP"), "hbm"), new CParameter(CType.Long, "cbBuffer"), new CParameter(CType.ObjectFarPtr, "lpvBits") }), CType.Long, uiGdi, 74));
			this.oGlobalNamespace.APIFunctions.Add("GetBkColor", new CFunction(this, CallTypeEnum.Pascal, "GetBkColor", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("COLORREF"), uiGdi, 75));
			this.oGlobalNamespace.APIFunctions.Add("GetBkMode", new CFunction(this, CallTypeEnum.Pascal, "GetBkMode", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc") }), CType.Int, uiGdi, 76));
			this.oGlobalNamespace.APIFunctions.Add("GetDeviceCaps", new CFunction(this, CallTypeEnum.Pascal, "GetDeviceCaps", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc"), new CParameter(CType.Int, "iCapability") }), CType.Int, uiGdi, 80));
			this.oGlobalNamespace.APIFunctions.Add("GetPixel", new CFunction(this, CallTypeEnum.Pascal, "GetPixel", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc"), new CParameter(CType.Int, "nXPos"), new CParameter(CType.Int, "nYPos") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("COLORREF"), uiGdi, 83));
			this.oGlobalNamespace.APIFunctions.Add("GetStockObject", new CFunction(this, CallTypeEnum.Pascal, "GetStockObject", new List<CParameter>(new CParameter[] { new CParameter(CType.Int, "fnObject") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HGDIOBJ"), uiGdi, 87));
			this.oGlobalNamespace.APIFunctions.Add("GetTextColor", new CFunction(this, CallTypeEnum.Pascal, "GetTextColor", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("COLORREF"), uiGdi, 90));
			this.oGlobalNamespace.APIFunctions.Add("GetTextExtent", new CFunction(this, CallTypeEnum.Pascal, "GetTextExtent", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc"), new CParameter(CType.LPCSTR, "lpszString"), new CParameter(CType.Int, "cbString") }), CType.DWord, uiGdi, 91));
			this.oGlobalNamespace.APIFunctions.Add("GetTextMetrics", new CFunction(this, CallTypeEnum.Pascal, "GetTextMetrics", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("TextMetricFarPtr"), "lptm") }), CType.Bool, uiGdi, 93));
			this.oGlobalNamespace.APIFunctions.Add("SetBitmapBits", new CFunction(this, CallTypeEnum.Pascal, "SetBitmapBits", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HBITMAP"), "hbmp"), new CParameter(CType.DWord, "cBits"), new CParameter(CType.ObjectFarPtr, "lpvBits") }), CType.Long, uiGdi, 106));
			this.oGlobalNamespace.APIFunctions.Add("AddFontResource", new CFunction(this, CallTypeEnum.Pascal, "AddFontResource", new List<CParameter>(new CParameter[] { new CParameter(CType.LPCSTR, "lpszFilename") }), CType.Int, uiGdi, 119));
			this.oGlobalNamespace.APIFunctions.Add("RemoveFontResource", new CFunction(this, CallTypeEnum.Pascal, "RemoveFontResource", new List<CParameter>(new CParameter[] { new CParameter(CType.LPCSTR, "lpszFile") }), CType.Bool, uiGdi, 136));
			this.oGlobalNamespace.APIFunctions.Add("UnrealizeObject", new CFunction(this, CallTypeEnum.Pascal, "UnrealizeObject", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HGDIOBJ"), "hgdiobj") }), CType.Bool, uiGdi, 150));
			this.oGlobalNamespace.APIFunctions.Add("GetBitmapDimension", new CFunction(this, CallTypeEnum.Pascal, "GetBitmapDimension", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HBITMAP"), "hbm") }), CType.DWord, uiGdi, 162));
			this.oGlobalNamespace.APIFunctions.Add("SetBitmapDimension", new CFunction(this, CallTypeEnum.Pascal, "SetBitmapDimension", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HBITMAP"), "hbmp"), new CParameter(CType.Int, "nWidth"), new CParameter(CType.Int, "nHeight") }), CType.DWord, uiGdi, 163));
			...
			this.oGlobalNamespace.APIFunctions.Add("SetTextAlign", new CFunction(this, CallTypeEnum.Pascal, "SetTextAlign", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc"), new CParameter(CType.UInt, "fuAlign") }), CType.UInt, uiGdi, 346));
			this.oGlobalNamespace.APIFunctions.Add("CreatePalette", new CFunction(this, CallTypeEnum.Pascal, "CreatePalette", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("LogPaletteFarPtr"), "lplgpl") }), this.oGlobalNamespace.GlobalTypes.GetValueByKey("HPALETTE"), uiGdi, 360));
			this.oGlobalNamespace.APIFunctions.Add("SetPaletteEntries", new CFunction(this, CallTypeEnum.Pascal, "SetPaletteEntries", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HPALETTE"), "hpal"), new CParameter(CType.UInt, "iStart"), new CParameter(CType.UInt, "cEntries"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("PaletteEntryFarPtr"), "lppe") }), CType.UInt, uiGdi, 364));
			this.oGlobalNamespace.APIFunctions.Add("AnimatePalette", new CFunction(this, CallTypeEnum.Pascal, "AnimatePalette", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HPALETTE"), "hpal"), new CParameter(CType.UInt, "iStart"), new CParameter(CType.UInt, "cEntries"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("PaletteEntryFarPtr"), "lppe") }), CType.Void, uiGdi, 367));
			this.oGlobalNamespace.APIFunctions.Add("GetSystemPaletteEntries", new CFunction(this, CallTypeEnum.Pascal, "GetSystemPaletteEntries", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("HDC"), "hdc"), new CParameter(CType.UInt, "iStart"), new CParameter(CType.UInt, "cEntries"), new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("PaletteEntryFarPtr"), "lppe") }), CType.UInt, uiGdi, 375));
			...
			uint uiMMSystem = GetModuleSegment("MMSYSTEM");

			this.oGlobalNamespace.APIFunctions.Add("sndPlaySound", new CFunction(this, CallTypeEnum.Pascal, "sndPlaySound", new List<CParameter>(new CParameter[] { new CParameter(CType.LPCSTR, "lpszSoundName"), new CParameter(CType.UInt, "wFlags") }), CType.Bool, uiMMSystem, 2));
			this.oGlobalNamespace.APIFunctions.Add("mciSendCommand", new CFunction(this, CallTypeEnum.Pascal, "mciSendCommand", new List<CParameter>(new CParameter[] { new CParameter(CType.UInt, "wDeviceID"), new CParameter(CType.UInt, "wMessage"), new CParameter(CType.DWord, "dwParam1"), new CParameter(CType.DWord, "dwParam2") }), CType.DWord, uiMMSystem, 701));

			uint uiCommDlg = GetModuleSegment("COMMDLG");

			this.oGlobalNamespace.APIFunctions.Add("GetOpenFileName", new CFunction(this, CallTypeEnum.Pascal, "GetOpenFileName", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("OpenFilenameFarPtr"), "lpofn") }), CType.Bool, uiCommDlg, 1));
			this.oGlobalNamespace.APIFunctions.Add("GetSaveFileName", new CFunction(this, CallTypeEnum.Pascal, "GetSaveFileName", new List<CParameter>(new CParameter[] { new CParameter(this.oGlobalNamespace.GlobalTypes.GetValueByKey("OpenFilenameFarPtr"), "lpofn") }), CType.Bool, uiCommDlg, 2));
			this.oGlobalNamespace.APIFunctions.Add("CommDlgExtendedError", new CFunction(this, CallTypeEnum.Pascal, "CommDlgExtendedError", new List<CParameter>(new CParameter[] { }), CType.DWord, uiCommDlg, 26));
		}
		...
		public CFunction GetFunction(uint segment, uint offset)
		{
			...
			for (int i = 0; i < this.aLibraryMatches.Count; i++)
			{
				...
				int iStart = (int)offset - match.Start;

				if (match.Segment == segment && iStart >= 0 && iStart < match.Length)
				{
					CModule module = match.Module;
					for (int j = 0; j < module.PublicNames.Count; j++)
					{
						...
						{
							if (publicNameDef.PublicNames[k].Value == iStart)
							{
			...
			if (segment == 0)
			{
				...
				{
					uint uiNewOffset = (offset + (uint)instruction.Bytes.Count + instruction.Parameters[0].Value) & 0xffff;

					CFunction function1 = this.GetFunction(segment, uiNewOffset);
					if (function1 != null)
					{
		...
		public void Decompile(string name, CallTypeEnum callType, List<CParameter> parameters, CType returnValue, uint segment, uint offset)
		{
			for (int i = 0; i < this.oGlobalNamespace.Functions.Count; i++)
			{
